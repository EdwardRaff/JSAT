...
/**
 * Contains pre determined code for generating specific data sets. The form and values of the data set are fixed, and do
 * not need to be specified. Training and testing sets are generated by the same methods.
 *
 * @author Edward Raff
 */
public class FixedProblems {
  ...
  /**
   * Creates a new Regression problem of the for x<sub>2</sub>+c sin(x<sub>2</sub>) = y. It is meant to be an easy test
   * case for non-linear regression algorithms.
   *
  ...
  /**
   * Returns a classification problem with small uniform noise where there is a small circle of radius 1 within a circle
   * of radius 4. Each circle shares the same center.
   *
