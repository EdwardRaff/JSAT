...
public class NystromTest {
  ...
  public void testClone() {
    ...
    DataModelPipeline instance = new DataModelPipeline((Classifier) new DCDs(),
        new Nystrom.NystromTransformFactory(new RBFKernel(0.5), 250, Nystrom.SamplingMethod.NORM, 1e-5, true));
  ...
  public void testTrainC_ClassificationDataSet() {
    ...
    for (final Nystrom.SamplingMethod sampMethod : Nystrom.SamplingMethod.values()) {
      final DataModelPipeline instance = new DataModelPipeline((Classifier) new DCDs(),
          new Nystrom.NystromTransformFactory(new RBFKernel(0.5), 250, sampMethod, 1e-5, false));

      final ClassificationDataSet train = FixedProblems.getInnerOuterCircle(400, new XORWOW());
