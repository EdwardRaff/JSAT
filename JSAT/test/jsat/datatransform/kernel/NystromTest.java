...
public class NystromTest
{
    ...
    public void testTrainC_ClassificationDataSet_ExecutorService()
    {
        ...
        {
            final DataModelPipeline instance = new DataModelPipeline((Classifier)new DCDs(), new Nystrom.NystromTransformFactory(new RBFKernel(0.5), 250, sampMethod, 1e-5, false)); 
