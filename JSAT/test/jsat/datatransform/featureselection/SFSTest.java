...
public class SFSTest {
  ...
  /**
   * Creates a naive test case where 4 classes that can be separated with 3 features are placed into a 10 dimensional
   * space. The other 7 dimensions are all small random noise values.
   *
