...
public class MathTricksTest {
  ...
  public void testSoftmax_Vec_boolean() {
    ...
    final Vec xExpected = new DenseVector(
        new double[] { 0.6652409557748218895, 0.090030573170380457998, 0.24472847105479765 });
    final Vec x2Expected = new DenseVector(
        new double[] { 0.64391425988797231, 0.087144318742032567489, 0.23688281808991013 });
