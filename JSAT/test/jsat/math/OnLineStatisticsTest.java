...
public class OnLineStatisticsTest {
  ...
  private final double[] data = new double[] { 1.43725, 3.57142, 1.02601, 0.962941, 2.35466, 2.28253, 1.71812, 2.92907,
      0.707891, 0.0136063, 2.9936, 2.06371, 0.274257, 0.23791, 0.0649932, 0.454671, 5.0087, 1.08846, 3.67667, 3.03826 };
  ...
  public void testAdd_OnLineStatistics_OnLineStatistics() {
    ...
    for (int j = 1; j < data.length - 1; j++) {
      ...
      assertEquals(variance, stats.getVarance(), 1e-8);
      assertEquals(skewness, stats.getSkewness(), 1e-8);
      assertEquals(kurt, stats.getKurtosis(), 1e-1);// The kurtois is not
