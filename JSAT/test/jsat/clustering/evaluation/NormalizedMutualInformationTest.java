...
public class NormalizedMutualInformationTest {
  ...
  public void testEvaluate_intArr_DataSet() {
    ...
    final ClassificationDataSet cds = new ClassificationDataSet(0, new CategoricalData[] {}, new CategoricalData(3));
    // Using example case from Manning's book
    // http://nlp.stanford.edu/IR-book/html/htmledition/evaluation-of-clustering-1.html
    final Vec emptyVec = new DenseVector(0);
    final int[] clusterAssign = new int[17];
    final int X = 0, O = 1, D = 2;
    clusterAssign[0] = 0;
    cds.addDataPoint(emptyVec, X);
    clusterAssign[1] = 0;
    cds.addDataPoint(emptyVec, X);
    clusterAssign[2] = 0;
    cds.addDataPoint(emptyVec, X);
    ...
    cds.addDataPoint(emptyVec, X);
    clusterAssign[5] = 0;
    cds.addDataPoint(emptyVec, O);

    clusterAssign[6] = 1;
    cds.addDataPoint(emptyVec, X);
    clusterAssign[7] = 1;
    cds.addDataPoint(emptyVec, D);
    clusterAssign[8] = 1;
    cds.addDataPoint(emptyVec, O);
    clusterAssign[9] = 1;
    cds.addDataPoint(emptyVec, O);
