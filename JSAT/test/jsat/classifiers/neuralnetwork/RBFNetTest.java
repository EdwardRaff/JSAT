...
public class RBFNetTest
{
    ...
    public void testTrainC_ClassificationDataSet_ExecutorService()
    {
        ...
        ClassificationDataSet trainSet = FixedProblems.getInnerOuterCircle(700, new Random(2));
    ...
    public void testTrain_RegressionDataSet_ExecutorService()
    {
        ...
        RegressionDataSet trainSet =  FixedProblems.getSimpleRegression1(700, new XORWOW(2));
        RegressionDataSet testSet =  FixedProblems.getSimpleRegression1(50, new XORWOW(3));
