...
public class UniformDiscreteTest {
  ...
  public void testCdf() {
    ...
    final UniformDiscrete instance = new UniformDiscrete(2, 9);

    final double[] expected_7 = new double[] { 0, 0, 0.125000000000000, 0.250000000000000, 0.375000000000000,
        0.500000000000000, 0.625000000000000, 0.750000000000000, 0.875000000000000, 1.00000000000000,
        1.00000000000000 };
  ...
  public void testLogPmf() {
    ...
    final double[] expected_7 = new double[] { -Double.MAX_VALUE, -Double.MAX_VALUE, -2.07944154167984,
        -2.07944154167984, -2.07944154167984, -2.07944154167984, -2.07944154167984, -2.07944154167984,
        -2.07944154167984, -2.07944154167984, -Double.MAX_VALUE };
  ...
  public void testPmf() {
    ...
    final double[] expected_7 = new double[] { 0, 0, 0.125000000000000, 0.125000000000000, 0.125000000000000,
        0.125000000000000, 0.125000000000000, 0.125000000000000, 0.125000000000000, 0.125000000000000, 0 };
  ...
  public void testSample() {
    ...
    assertTrue(instance.median() == 5 || instance.median() == 6);// both are
                                                                 // valid for
                                                                 // this case
  ...
  public void testSummaryStats() {
    ...
    final double[] expected_7_5 = { 5.50000000000000, 5.00000000000000, 5.25000000000000, 2.29128784747792, 0 };
