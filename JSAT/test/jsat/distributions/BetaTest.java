...
public class BetaTest
{
    ...
    public void testMin()
    {
        ...
        Distribution dist = new Beta(0.5, 3);
    ...
    public void testMean()
    {
        ...
        Distribution dist = new Beta(0.5, 0.5);
    ...
    public void testEquals(){
    	...
    	Distribution d1 = new Beta(0.5, 0.5);
    	Distribution d2 = new Beta(0.6, 0.5);
    	Distribution d3 = new Beta(0.5, 0.6);
    	Distribution d4 = new Beta(0.5, 0.5);
