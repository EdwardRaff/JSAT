...
public class FisherSendorTest
{
    ...
    public void testEquals(){
    	...
    	Distribution d1 = new FisherSendor(0.5, 0.5);
    	Distribution d2 = new FisherSendor(0.6, 0.5);
    	Distribution d3 = new FisherSendor(0.5, 0.6);
    	Distribution d4 = new FisherSendor(0.5, 0.5);
