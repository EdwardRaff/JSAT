...
public class StringUtilsTest {
  ...
  protected void assertRelativeEquals(final double truth, final double attempt) {
    ...
    if (Double.isNaN(truth)) {
      ...
      assertTrue(Double.doubleToRawLongBits(truth) == Double.doubleToRawLongBits(attempt));// get
                                                                                           // the
                                                                                           // signs
                                                                                           // right
    } else {
  ...
  public void testParseDouble() {
    ...
    for (int trials = 0; trials < 10000; trials++) {
      ...
      // [sign][val]
      toTest = signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(6)))) + ""
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(6))));
      ...
      // [sign][val].[val]
      toTest = signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(6)))) + "." + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(6))));
      truth = Double.parseDouble(toTest);
      attempt = StringUtils.parseDouble(toTest, 0, toTest.length());
      assertRelativeEquals(truth, attempt);
      ...
      toTest = signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(6)))) + Es[rand.nextInt(2)]
          + signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(2))));
      truth = Double.parseDouble(toTest);
      attempt = StringUtils.parseDouble(toTest, 0, toTest.length());
      assertRelativeEquals(truth, attempt);

      // harder cases, may have nonsense values (over flow to Inf/NegInf,
      // underflows to 0)
      // [sign][val]
      // XXX This code generates a random signed integer and then computes the
      ...
      // Integer.MIN_VALUE). (Same problem arised for long values as well).
      toTest = signOps[rand.nextInt(3)].replace("-", "") + zeros[rand.nextInt(zeros.length)]
          + Math.max(Math.abs(rand.nextLong()), 0);
      truth = Double.parseDouble(toTest);
      attempt = StringUtils.parseDouble(toTest, 0, toTest.length());
      assertRelativeEquals(truth, attempt);

      // [sign][val].[val]
      toTest = signOps[rand.nextInt(3)] + rand.nextInt(Integer.MAX_VALUE) + zeros[rand.nextInt(zeros.length)] + "."
          + zeros[rand.nextInt(zeros.length)] + rand.nextInt(Integer.MAX_VALUE);
      truth = Double.parseDouble(toTest);
      attempt = StringUtils.parseDouble(toTest, 0, toTest.length());
      assertRelativeEquals(truth, attempt);
      ...
      // [sign][val][eE][sign][val]
      toTest = signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)]
          + rand.nextInt((int) Math.round(Math.pow(10, rand.nextInt(8)))) + Es[rand.nextInt(2)]
          + signOps[rand.nextInt(3)] + zeros[rand.nextInt(zeros.length)] + rand.nextInt(450);
      truth = Double.parseDouble(toTest);
      attempt = StringUtils.parseDouble(toTest, 0, toTest.length());
      assertRelativeEquals(truth, attempt);
    }
