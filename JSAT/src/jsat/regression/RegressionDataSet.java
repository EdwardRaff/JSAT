...
/**
 * A RegressionDataSet is a data set specifically for the task of performing regression. Each data point is paired with
 * s double value that indicates its true regression value. An example of a regression problem would be mapping the
 * inputs of a function to its outputs, and attempting to learn the function from the samples.
 *
 * @author Edward Raff
 */
public class RegressionDataSet extends DataSet<RegressionDataSet> {
   ...
   * @param categories an array of length equal to the number of categorical attributes, each object describing the
  ...
  /**
   * Creates a new data set for the given list of data points. The data points will be copied, changes in one will not
   * effect the other.
   *
   * @param data the list of data point to create a data set from
   * @param predicting which of the numerical attributes is the regression target. Categorical attributes are ignored in
  ...
  /**
   * Creates a new regression data set by copying all the data points in the given list. Alterations to this list will
   * not effect this DataSet.
   *
  ...
  /**
   * Creates a new data point with no categorical variables to be added to the data set. The arguments will be used
   * directly, modifying them after will effect the data set.
   *
  ...
  /**
   * Creates a new data point to be added to the data set. The arguments will be used directly, modifying them after
   * will effect the data set.
   *
   * @param numerical the numerical values for the data point
  ...
  /**
   * Returns the i'th data point in the data set paired with its target regressor value. Modifying the DataPointPair
   * will effect the data set.
   *
  ...
  /**
   * Returns a new list containing copies of the data points in this data set, paired with their regression target
   * values. MModifications to the list or data points will not effect this data set
   *
   ...
   * Modifications to the list will not effect the data set, but modifying the points will. For a copy of the points,
   * use the {@link #getAsDPPList() } method.
   *
  ...
  /**
   * Returns a vector containing the target regression values for each data point. The vector is a copy, and
   * modifications to it will not effect the data set.
   *
  ...
  /**
   * Creates a new data set that uses the given list as its backing list. No copying is done, and changes to this list
   * will be reflected in this data set, and the other way.
   *
