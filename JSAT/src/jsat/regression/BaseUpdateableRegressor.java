...
/**
 * A base implementation of the UpdateableRegressor. null {@link #train(jsat.regression.RegressionDataSet, java.util.concurrent.ExecutorService)
 * }
 * will simply call {@link #train(jsat.regression.RegressionDataSet) }, which will call null {@link #setUp(jsat.classifiers.CategoricalData[], int)
 * } and then call {@link #update(jsat.classifiers.DataPoint, double) } for each data point in a random order.
 *
 * @author Edward Raff
 */
