...
/**
 * A kernelized implementation of Ridge Regression. Ridge Regression is equivalent to {@link MultipleLinearRegression}
 * with an added L<sub>2</sub> penalty for the weight vector. <br><br>
 * This algorithm is very expensive to compute O(n<sup>3</sup>), where n is the number of training points.
 *
 * @author Edward Raff
 */
public class KernelRidgeRegression implements Regressor, Parameterized {
  ...
  /**
   * Sets the regularization parameter used. The value of lambda depends on the data set and kernel used, with easier
   * problems using smaller lambdas.
   *
