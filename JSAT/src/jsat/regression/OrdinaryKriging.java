...
/**
 * An implementation of Ordinary Kriging with support for a uniform error measurement. When an
 * {@link #getMeasurementError() error} value is applied, Kriging becomes equivalent to Gaussian Processes Regression.
 *
 * @author Edward Raff
 */
public class OrdinaryKriging implements Regressor, Parameterized {
  ...
  /**
   * Creates a new Ordinary Kriging with a small error value using the {@link PowVariogram power} variogram.
   */
   ...
   * While the measurement errors could be per data point, this implementation provides only a global error. If the
  ...
  /**
   * Returns the measurement error used for Kriging, which is equivalent to altering the diagonal values of the
   * covariance. While the measurement errors could be per data point, this implementation provides only a global error.
   * If the error is set to zero, it will perfectly interpolate all data points.
   *
  ...
  /**
   * Sets the nugget value passed to the variogram during training. The nugget allows the variogram to start from a
   * non-zero value, and is equivalent to alerting the off diagonal values of the covariance. <br>
  ...
  /**
   * Returns the nugget value passed to the variogram during training. The nugget allows the variogram to start from a
   * non-zero value, and is equivalent to alerting the off diagonal values of the covariance.
   *
  ...
  public static interface Variogram extends Cloneable {
     ...
     * @param nugget the nugget value to add tot he variogram, may be ignored if the variogram want to fit it
     * automatically
     */
