...
/**
 * A Stochastic implementation of Ridge Regression. Ridge Regression is equivalent to {@link MultipleLinearRegression}
 * with an added L<sub>2</sub> penalty for the weight vector. <br><br>
 * This algorithm works best for problems with a large number of data points or very high dimensional problems.
 *
 * @author Edward Raff
 */
public class StochasticRidgeRegression implements Regressor, Parameterized, SingleWeightVectorModel {
  ...
  /**
   * Sets the learning rate decay function to use. The decay is applied after each epoch through the data set. Using a
   * decay rate can reduce the time to converge and quality of the solution for difficult problems.
   *
  ...
  /**
   * Sets the batch size to learn from. If larger than the training set, the problem will reduce to classic gradient
   * descent.
   *
