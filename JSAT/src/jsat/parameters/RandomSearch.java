...
/**
 * Random Search is a simple method for tuning the parameters of a classification or regression algorithm. Each
 * parameter is given a distribution that represents the values of interest, and trials are done by randomly sampling
 * each parameter from their respective distributions. Compared to {@link GridSearch} this method does better when lots
 * of values are to be tested or when 2 or more parameters are to be evaluated. <br>
 ...
 * methods.
 *
 * See : Bergstra, J., & Bengio, Y. (2012). <i>Random Search for Hyper-Parameter Optimization</i>. Journal ofMachine
...
public class RandomSearch extends ModelSearch {
  ...
  /**
   * Sets the number of trials or samples that will be taken. This value is the number of models that will be trained
