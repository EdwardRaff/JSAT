...
/**
 * It may be necessary to learn the same transform from several different versions of a data set, this interface
...
public interface DataTransformFactory {
   ...
   * @throws FailedToFitException if the transform could not be constructed or was inappropriate for the given data set.
   */
