...
/**
 * This interface behaves exactly as {@link InPlaceTransform} specifies, with the addition of an in-place "reverse"
 * method that can be used to alter any given transformed data point back into an <i>approximation</i> of the original
 * vector, without having to new vector object, but altering the one given.
 *
 * @author Edward Raff
 */
public interface InPlaceInvertibleTransform extends InPlaceTransform, InvertibleTransform {
   ...
   * output of {@link #inverse(jsat.classifiers.DataPoint) }
   *
