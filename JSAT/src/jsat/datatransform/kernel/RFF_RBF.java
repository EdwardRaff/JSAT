...
public class RFF_RBF implements DataTransform
{
    ...
    static public class RFF_RBFTransformFactory implements DataTransformFactory
    {
         ...
         * @param dimension the new feature size dimension to project into. 
         * @param inMemory {@code true} if the internal matrix should be stored in 
         * memory. If {@code false}, the memory will be re-computed as needed, 
         * increasing computation cost but uses no extra memory. 
         */
        public RFF_RBFTransformFactory(double sigma, int dimension, boolean inMemory)
        {
            this.sigma = sigma;
        ...
        {
            return new RFF_RBF(dataset.getNumNumericalVars(), sigma, dimension, new Random(), inMemory);
        }
