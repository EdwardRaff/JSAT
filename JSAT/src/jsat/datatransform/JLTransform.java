...
/**
 * The Johnson-Lindenstrauss (JL) Transform is a type of random projection down to a lower dimensional space. The goal
 * is, with a high probability, to keep the {@link EuclideanDistance  Euclidean distances} between points approximately
 * the same in the original and projected space. <br>
 * The JL lemma, with a high probability, bounds the error of a distance computation between two points <i>u</i> and
 * <i>v</i> in the lower dimensional space by (1 &plusmn; &epsilon;) d(<i>u</i>, <i>v</i>)<sup>2</sup>, where d is the
 * Euclidean distance. It works best for very high dimension problems, 1000 or more.
 * <br>
 * For more information see: <br>
 * Achlioptas, D. (2003). <i>Database-friendly random projections: Johnson-Lindenstrauss with binary coins</i>. Journal
 * of Computer and System Sciences, 66(4), 671–687. doi:10.1016/S0022-0000(03)00025-4
 *
 * @author Edward Raff
 */
public class JLTransform implements DataTransform {
  ...
  public enum TransformMode {
    /**
     * The transform matrix values come from the gaussian distribution and is dense <br><br>
    ...
    BINARY,
    /**
     * The transform matrix values are sparse. NOTE: this sparsity is not currently taken advantage of
     */
    SPARSE
  }
   ...
   * @param mode how to construct the transform
   * @param rand the source of randomness
   * @param inMemory if {@code false}, the matrix will be stored in O(1) memory at the cost of execution time.
   */
