...
public interface DataTransform extends Cloneable, Serializable {
   ...
   * point. This new data point is a different object, but may contain the same
   * references as the original data point. It is not guaranteed that you can
   * mutate the transformed point without having a side effect on the original
   * point.
   *
   * @param dp
   *          the data point to apply a transformation to
