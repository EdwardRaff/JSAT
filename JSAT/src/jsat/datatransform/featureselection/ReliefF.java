...
/**
 * Provides an implementation of the ReliefF algorithm for feature importance computing. Because JSAT does not support
 * neighbor searching for categorical values, it does not provides weights for categorical variables. <br>
 * Weight values are in the range [-1, 1]. The value is a measure of corelation, so the absolute value of the individual
 * weights would form its relative importance to the others. <br>
 * The ReliefF algorithm is meant for classification problems, and is computed in a nearest neighbor fashion. <br><br>
 * See:<br>Kononenko, I., Simec, E.,&amp;Robnik-Sikonja, M. (1997).
 * <i><a href="http://www.springerlink.com/index/W174714344273004.pdf">
 * Overcoming the myopia of inductive learning algorithms with RELIEFF</a></i>. Applied Intelligence, 7, 39–55.
 *
 * @author Edward Raff
 */
public class ReliefF extends RemoveAttributeTransform {
  ...
  /**
   * Creates a new ReliefF object to measure the importance of the variables with respect to a classification task. Only
   * numeric features will be removed. Categorical features will be ignored and left in tact by the transformation
   *
  ...
  public static class ReliefFFactory extends DataTransformFactoryParm {
     ...
     * Only numeric features will be removed. Categorical features will be ignored
     *
