...
/**
 * Sequential Backward Selection (SBS) is a greedy method of selecting a subset of features to use for prediction. It
 * starts from the set of all features and attempts to remove the least informative feature from the set at each
 * iteration
 *
 * @author Edward Raff
 */
public class SBS extends RemoveAttributeTransform {
   ...
   * @param evaluater the classifier to use in determining accuracy given a feature subset
   * @param folds the number of cross validation folds to use in selection
   * @param maxDecrease the maximum tolerable decrease in accuracy in accuracy when a feature is removed
   */
   ...
   * @param folds the number of cross validation folds to use in selection
   * @param maxDecrease the maximum tolerable increase in the error rate when a feature is removed
   */
   ...
   *
   * @param available the set of available features from [0, n) to consider for removal
   ...
   * @param PbestScore an array to behave as a pointer to the best score seen so far
   * @param maxDecrease the maximum allowable decrease in accuracy from the best accuracy we see
   * @return the feature that was selected to be removed, or -1 if none were removed
   */
  ...
  static public class SBSFactory extends DataTransformFactoryParm {
     ...
     *
     * @param maxDecrease the maximum allowable decrease in the accuracy rate compared to the previous set of features
     ...
     * Creates a new SBS transform factory
     *
     * @param maxDecrease the maximum allowable increase in the error rate compared to the previous set of features
    ...
    /**
     * Sets the maximum allowable decrease in accuracy (increase in error) from the previous set of features to the new
     * current set.
     *
     * @param maxDecrease the maximum allowable decrease in the accuracy from removing a feature
     */
     ...
     *
     * @return the maximum allowable decrease in accuracy from one set of features to the next
     */
