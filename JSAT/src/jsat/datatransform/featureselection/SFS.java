...
/**
 * Sequential Forward Selection (SFS) is a greedy method of selecting a subset of features to use for prediction. It
 * starts from the set of no features and attempts to add the next best feature to the set at each iteration.
 *
 * @author Edward Raff
 */
public class SFS implements DataTransform {
   ...
   * @param maxIncrease the maximum tolerable increase in error when a feature is added
   */
   ...
   * @param maxFeatures the maximum number of features to find
   * @param dataSet the data set to perform feature selection on
   * @param regressor the regressor to use in determining accuracy given a feature subset
   * @param folds the number of cross validation folds to use in selection
   * @param maxIncrease the maximum tolerable increase in error when a feature is added
   */
   ...
   *
   * @param available the set of available features from [0, n) to consider for adding
