 ...
 * several different transforms to learn and then apply. <br>
 * <br>
...
public class DataTransformProcess implements DataTransform, Parameterized {
  ...
  /**
   * Creates a new transform process that is empty. Transform factories must be
   * added using {@link #addTransform(jsat.datatransform.DataTransformFactory) }
   * .
   */
   ...
   *
   * @param transform
   *          the factory for the transform to add
   */
  ...
  /**
   * Consolidates transformation objects when possible. Currently only works
   * with {@link RemoveAttributeTransform}
   */
   ...
   *
   * @param dataSet
   *          the data set to learn a series of transforms from
   */
  ...
  /**
   * Learns the transforms for the given data set. The data set is then altered
   * after each transform is learned so the next transform can be learned as
   * well. <br>
   ...
   *
   * @param dataSet
   *          the data set to learn a series of transforms from and alter into
   *          the final transformed form
   */
