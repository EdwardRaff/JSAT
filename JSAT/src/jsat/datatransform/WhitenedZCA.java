...
/**
 * An extension of {@link WhitenedPCA}, is the Whitened Zero Component Analysis. Whitened ZCA can not project to a lower
 * dimension, as it rotates the output in the original dimension.
 *
 * @author Edward Raff
 */
public class WhitenedZCA extends WhitenedPCA implements InPlaceTransform {
  ...
  /**
   * Creates a new Whitened ZCA. The regularization parameter will be chosen as the log of the condition of the
   * covariance.
   *
   * @param dataSet the data set to whiten
   */
  ...
  static public class WhitenedZCATransformFactory extends DataTransformFactoryParm {
    ...
    /**
     * Creates a new WhitenedZCA factory that will use the regularization value provided
     *
    ...
    /**
     * Creates a new WhitenedZCA where the regularization will be determined automatically
     */
     ...
     *
     * @param autoReg {@code true} to automatically select a regularization vale, {@code false} to use the value set by 
    ...
    /**
     * Returns whether or not the regularization parameter is determined automatically.
     *
    ...
    /**
     * Sets the amount of regularization to use, this value will be ignored if {@link #setAutoReg(boolean) } is set to
     * {@code true}
     *
    ...
    /**
     * Returns the amount of regularization that will be used if {@link #isAutoReg() } is {@code false}.
     *
