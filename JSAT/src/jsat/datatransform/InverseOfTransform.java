...
/**
 * Creates a new Transform object that simply uses the inverse of an {@link InvertibleTransform} as a regular transform.
 * This allows one to apply inverses after the fact in a simple matter like:
 * <pre><code>
...
public class InverseOfTransform implements DataTransform {
  ...
  /**
   * Creates a new transform that uses the null null   {@link InvertibleTransform#transform(jsat.classifiers.DataPoint) 
