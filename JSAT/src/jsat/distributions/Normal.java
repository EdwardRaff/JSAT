...
public class Normal extends ContinuousDistribution {
  ...
  private static double cdfApproxMarsaglia2004(final double x) {
    /*
     * Journal of Statistical Software (July 2004, Volume 11, Issue 5), George
     * Marsaglia Algorithum to compute the cdf of the normal distribution for
     * some z score
     */
    double s = x, t = 0, b = x;
    final double q = x * x;
   ...
   *
   * @param x
   *          the value to the get log(pdf) of
   * @param mu
  ...
  public boolean equals(final Object obj) {
    ...
    return Double.doubleToLongBits(stndDev) == Double.doubleToLongBits(other.stndDev);
  }
  ...
  public double invPdf(final double d) {
     ...
     *
     * 2 (mu - x) --------- 2 ____ 2 sigma / __ e \/ 2 || sigma
     *
     */
