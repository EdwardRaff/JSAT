...
/**
 * This abstract class defines the contract for a distribution over the integer values.<br>
 * <br>
 * The {@link #cdf(double) } method will behave by {@link Math#floor(double) rounding down} and then calling the integer {@link #cdf(int)
 * } counterpart.
 *
 * @author Edward Raff
 */
abstract public class DiscreteDistribution extends Distribution {
  ...
  /**
   * Computes the log of the Probability Mass Function. Note, that then the probability is zero,
