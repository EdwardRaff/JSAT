...
/**
 * Many Kernels can be described in terms the L2 norm with some operations performed on it. For example, the
 * {@link RBFKernel} and {@link RationalQuadraticKernel} can both be expressed in terms of the L<sub>2</sub> norm of the
 * two inputs. To simplify the addition of other kernels based on the same norm, this base class exists.<br>
 * <br>
 * All Kernels extending this base kernel support acceleration. This is done making use of the fact that || x - y
 * ||<sup>2</sup> = x x' +y y' - 2 x y' <br>
