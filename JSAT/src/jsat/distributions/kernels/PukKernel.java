...
/**
 * The PUK kernel is an alternative to the RBF Kernel. By altering the {@link #setOmega(double) omega} parameter the
 * behavior of the PUK kernel can be controlled. The {@link #setSigma(double) sigma} parameter works in the same way as
 * the RBF Kernel.<br>
 * <br>
 * See: Üstün, B., Melssen, W. J.,&amp;Buydens, L. M. C. (2006). <i>Facilitating the application of Support Vector
 * Regression by using a universal Pearson VII function based kernel</i>. Chemometrics and Intelligent Laboratory
 * Systems, 81(1), 29–40. doi:10.1016/j.chemolab.2005.09.003
 *
 * @author Edward Raff
 */
