...
public class RBFKernel extends BaseL2Kernel {
  ...
  /**
   * Another common (equivalent) form of the RBF kernel is k(x, y) = exp(-&gamma;||x-y||<sup>2</sup>). This method
   * converts the &sigma; value used by this class to the equivalent &gamma; value.
   *
  ...
  /**
   * Another common (equivalent) form of the RBF kernel is k(x, y) = exp(-&gamma;||x-y||<sup>2</sup>). This method
   * converts the &gamma; value equivalent &sigma; value used by this class.
   *
  ...
  /**
   * Guess the distribution to use for the kernel width term {@link #setSigma(double) &sigma;} in the RBF kernel.
   *
