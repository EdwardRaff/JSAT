...
public class Weibull extends ContinuousDistribution {
  ...
  public void setUsingData(final Vec data) {
    /*
     * Method of parameter esstimation is more complex than for other
     * distirbutions, see
     * http://www.qualitydigest.com/jan99/html/body_weibull.html for the method
     * used. NOTE the above article has alpha and beta in oposite order
     */
    ...
    /*
     * We can now compute alpha directly. Note the page use y = m x + b, instead
     * of y = b x + a
     *
     */
