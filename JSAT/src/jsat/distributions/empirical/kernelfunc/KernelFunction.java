...
/**
 * Class for representing one dimensional kernel functions. Since they require no parameters and have no need for
 * duplication, its is advised to make them singletons.
 *
...
public interface KernelFunction extends Serializable {
  ...
  /**
   * As the value of |u| for the kernel function approaches infinity, the value of k(u) approaches zero. This function
   * returns the minimal absolute value of u for which k(u) returns 0
   *
