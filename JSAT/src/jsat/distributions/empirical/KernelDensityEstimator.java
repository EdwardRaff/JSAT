...
/**
 * Kernel Density Estimator, KDE, uses the data set itself to approximate the underlying probability distribution using
 * {@link KernelFunction Kernel Functions}.
 *
 * @author Edward Raff
 */
public class KernelDensityEstimator extends ContinuousDistribution {
  ...
  /**
   * Sets the bandwidth used for smoothing. Higher values make the pdf smoother, but can obscure features. Too small a
   * bandwidth will causes spikes at only the data points.
   *
