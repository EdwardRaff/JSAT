...
public interface MultivariateDistribution extends Cloneable, Serializable {
  ...
  /**
   * Computes the log of the probability density function. If the probability of the input is zero, the log of zero
   * would be {@link Double#NEGATIVE_INFINITY}. Instead, -{@link Double#MAX_VALUE} is returned.
   *
  ...
  /**
   * Returns the probability of a given vector from this distribution. By definition, the probability will always be in
   * the range [0, 1].
   *
  ...
  /**
   * Sets the parameters of the distribution to attempt to fit the given list of vectors. All vectors are assumed to
  ...
  /**
   * Sets the parameters of the distribution to attempt to fit the given list of data points. The
   * {@link DataPoint#getWeight()  weights} of the data points will be used.
   *
