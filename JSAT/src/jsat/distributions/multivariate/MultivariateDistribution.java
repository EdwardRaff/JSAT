...
/**
 * This interface represents the contract that any continuous multivariate
...
public interface MultivariateDistribution extends Cloneable, Serializable {
   ...
   * the input is zero, the log of zero would be
   ...
   *           if the vector is not the correct length, or the distribution has
   *           not yet been set
   */
   ...
   *
   * @param x
   *          the vector the get the log probability of
   * @return the log of the probability.
   * @throws ArithmeticException
   *           if the vector is not the correct length, or the distribution has
   *           not yet been set
   ...
   *
   * @param count
   *          the number of iid samples to draw
   * @param rand
   ...
   *
   * @param dataPoints
   *          the list of data points to use
   * @return <tt>true</tt> if the distribution was fit to the data, or
   *         <tt>false</tt> if the distribution could not be fit to the data
   *         set.
   */
