...
/**
 * The Log Uniform distribution is such that if X is the distribution, then Y = log(X) is uniformly distributed. Because
 * of this log term, this distribution can only take values in a positive range.
 *
