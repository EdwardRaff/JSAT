...
public abstract class ContinuousDistribution extends Distribution {
   ...
   *
   * @param dist
   *          the distribution to wrap the pdf of
   ...
   * distribution. The order must always be the same, and match up with the
   * values returned by {@link #getVariables() }
   *
  ...
  /**
   * The descriptive name of a distribution returns the name of the
   * distribution, followed by the parameters of the distribution and their
   * values.
   *
   ...
   * distribution. The order must always be the same, and match up with the
   * values returned by {@link #getCurrentVariableValues() }
   *
   ...
   *
   * @param data
   *          the data to use to attempt to fit against
   */
