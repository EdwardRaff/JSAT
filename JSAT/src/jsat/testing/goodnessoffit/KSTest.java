...
public class KSTest {
  ...
  /**
   * Creates a new statistical test for testing. The 1 sample test, with
   * <tt>v</tt> being the 1 sample. The 1 sample test compare the data to a
   * given distribution, and see if it does not belong to the given
   * distribution. The 2 sample test is designed to tell if the data is not from
   * the same population.
   *
   * @param v
   ...
   * @return the max difference between the empirical CDF and the 'true' CDF of
  ...
  /**
   * Returns the p-value for the 2 sample KS Test against the given data set
   * <tt>data</tt>. <br>
   * The null hypothesis of this test is that the given data set is from the
   * same population as <tt>data</tt> <br>
   * The alternative hypothesis is that the data set does not belong to the same
   * population as <tt>data</tt>
   *
   * @param data
   *          the other distribution to compare against
  ...
  /**
   * Returns the p-value for the KS Test against the given distribution
   * <tt>cd</tt>. <br>
   * The null hypothesis of this test is that the given data set belongs to the
   * given distribution. <br>
   * The alternative hypothesis is that the data set does not belong to the
   * given distribution.
   *
   *
   * @param cd
