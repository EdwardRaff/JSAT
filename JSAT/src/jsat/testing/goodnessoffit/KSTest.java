...
public class KSTest {
   ...
   * being the 1 sample. The 1 sample test compare the data to a given distribution, and see if it does not belong to
   * the given distribution. The 2 sample test is designed to tell if the data is not from the same population.
   *
