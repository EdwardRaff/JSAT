...
/**
 * This class provides efficient implementations of use full vector operations and updates. The implementations are
 * efficient for both dense and sparse vectors.
 *
 * @author Edward Raff
 */
public class VecOps {
  ...
  /**
   * Bad value to be given as a default so that the index returned is always invalid. Thus, we can avoid null checks and
   * just check on the index - avoiding additional code.
   */
