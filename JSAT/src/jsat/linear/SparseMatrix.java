 ...
 * decompositions.
 * <br> {@link #transposeMultiply(jsat.linear.Matrix, jsat.linear.Matrix, java.util.concurrent.ExecutorService) }
...
public class SparseMatrix extends Matrix {
  ...
  /**
   * Creates a new Sparse Matrix backed by the given array of SpareVectors. Altering the array of any object in it will
   * also alter the this matrix.
   *
