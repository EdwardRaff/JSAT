...
public class MatrixStatistics {
   ...
   *
   * @param means
   *          the already computed mean of the data set
   * @param dataset
   *          the data set to compute the covariance diagonal from
   ...
   *          the already computed mean of the data set
   * @param diag
   *          the zeroed out vector to store the diagonal in. Its contents will
   *          be altered
   * @param dataset
   *          the data set to compute the covariance diagonal from
   */
  ...
  /**
   * Computes the weighted covariance matrix of the given data set. Superfluous
   * calculations are avoided by having the call provide information.
   *
   * @param mean
   *          the mean of the data set
   * @param dataSet
   ...
   *          the zeroed out matrix to store the result into
   * @param sumOfWeights
   *          the sum of the weights for each data point in the dataset
   * @param sumOfSquaredWeights
   *          the sum of the squared weights for each data point in the data set
   */
  public static void covarianceMatrix(final Vec mean, final DataSet dataSet, final Matrix covariance,
      final double sumOfWeights, final double sumOfSquaredWeights) {
  ...
  /**
   * Computes the weighted result for the covariance matrix of the given data
   * set. If all weights have the same value, the result will come out
   * equivalent to {@link #covarianceMatrix(jsat.linear.Vec, java.util.List) }
   *
   * @param mean
   ...
   * @param covariance
   *          the zeroed matrix to store the result in. Its values will be
   *          altered.
   */
   ...
   *          altered.
   * @param sumOfWeights
   *          the sum of each weight in <tt>dataSet</tt>
   * @param sumOfSquaredWeights
   ...
   *
   * @param dataSet
   *          the dataset to compute the mean from
   ...
   *          the vector type
   * @param dataSet
   *          the list of vectors to compute the mean of
   ...
   *
   * @param mean
   *          the zeroed out vector to store the mean in. Its contents will be
   *          altered
   * @param dataSet
   *          the set of data points to compute the mean from
   */
