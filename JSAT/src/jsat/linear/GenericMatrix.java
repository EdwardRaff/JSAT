...
/**
 * This Class provides default implementations of most all functions in row major form. Only a small portion must be
...
public abstract class GenericMatrix extends Matrix {
  ...
  /**
   * Step size if the computation accesses 2*NB2^2 * dataTypeSize data, so that the data being worked on fits into the
   * L2 cache
   */
