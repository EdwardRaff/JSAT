...
public class RowColumnOps {
  ...
  /**
   * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] = A[i,:] .* c[i] The Matrix <tt>A</tt> and
   * vector <tt>c</tt> do not need to have the same dimensions, so long as they both have indices in the given range.
   *
   * @param A the matrix to perform he update on
   * @param i the row to update
   * @param start the first index of the row to update from (inclusive)
  ...
  /**
   * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] = A[i,:] .* c[i] The Matrix <tt>A</tt> and
   * array <tt>c</tt> do not need to have the same dimensions, so long as they both have indices in the given range.
   *
   * @param A the matrix to perform he update on
   * @param i the row to update
   * @param start the first index of the row to update from (inclusive)
   ...
   * The Matrix <tt>A</tt> and vector <tt>c</tt> do not need to have the same dimensions, so long as they both have
  ...
  /**
   * Updates the values of column <tt>j</tt> in the given matrix to be A[:,j] = A[:,j]/c[j].<br>
   * The Matrix <tt>A</tt> and array <tt>c</tt> do not need to have the same dimensions, so long as they both have
   * indices in the given range.
   *
   * @param A the matrix to perform he update on
   * @param j the row to update
