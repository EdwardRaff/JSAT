...
/**
 * A collection of mutable Row and Column operations that can be performed on
 * matrices.
 *
 * @author Edward Raff
 */
public class RowColumnOps {
  ...
  /**
   * Updates the values of column <tt>j</tt> in the given matrix to be A[:,j] =
   * A[:,j]+ c
   *
   * @param A
   *          the matrix to perform he update on
   * @param j
   *          the row to update
   * @param c
   *          the constant to add to each element
   */
   ...
   *          the row to update
   * @param start
   *          the first index of the row to update from (inclusive)
   * @param to
   *          the last index of the row to update (exclusive)
   * @param c
   *          the constant to add to each element
   */
  ...
  /**
   * Updates the values along the main diagonal of the matrix by adding a
   * constant to them
   *
   * @param A
   *          the matrix to perform the update on
   * @param start
   *          the first index of the diagonals to update (inclusive)
   * @param to
   *          the last index of the diagonals to update (exclusive)
   * @param c
   *          the constant to add to the diagonal
   */
   ...
   * Updates the values of column <tt>j</tt> in the given matrix to be A[:,j] =
   * A[:,j]+c[:]*<tt>t</tt>.<br>
   * The Matrix <tt>A</tt> and array <tt>c</tt> do not need to have the same
   * dimensions, so long as they both have indices in the given range.
   *
   * @param A
   *          the matrix to perform he update on
   * @param j
   ...
   * @param c
   *          the array of values to pairwise multiply by <tt>t</tt> before
   *          adding to the elements of A
   */
  public static void addMultCol(final Matrix A, final int j, final int start, final int to, final double t,
      final double[] c) {
    for (int i = start; i < to; i++) {
   ...
   * Updates the values of column <tt>j</tt> in the given matrix to be A[:,j] =
   * A[:,j]+c[:]*<tt>t</tt>.<br>
   * The Matrix <tt>A</tt> and vector <tt>c</tt> do not need to have the same
   * dimensions, so long as they both have indices in the given range.
   *
   * @param A
   *          the matrix to perform he update on
   ...
   *          the constant to multiply all elements of <tt>c</tt> by
   * @param c
   *          the vector of values to pairwise multiply by <tt>t</tt> before
   *          adding to the elements of A
   */
  public static void addMultCol(final Matrix A, final int j, final int start, final int to, final double t,
      final Vec c) {
  ...
  /**
   * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] =
   * A[i,:]+c[:]*<tt>t</tt>.<br>
   * The Matrix <tt>A</tt> and array <tt>c</tt> do not need to have the same
   * dimensions, so long as they both have indices in the given range.
   *
   ...
   *          the row to update
   * @param start
   *          the first index of the column to update from (inclusive)
   * @param to
   ...
   *          adding to the elements of A
   */
  public static void addMultRow(final Matrix A, final int i, final int start, final int to, final double t,
      final double[] c) {
   ...
   *          the last index of the row to update (exclusive)
   * @param c
   *          the array of values to pairwise divide the elements of A by
   */
  public static void divCol(final Matrix A, final int j, final int start, final int to, final double[] c) {
    for (int i = start; i < to; i++) {
   ...
   *          the last index of the row to update (exclusive)
   * @param c
   *          the vector of values to pairwise divide the elements of A by
   */
   ...
   * @param from
   *          the first column index to fill (inclusive)
   * @param to
   *          the last column index to fill (exclusive)
   * @param val
   *          the value to fill into the matrix
   */
   ...
   *          the row to update
   * @param c
   *          the array of values to multiple the elements of <tt>A</tt> by
   */
  public static void multRow(final Matrix A, final int i, final double[] c) {
    if (A.cols() != c.length) {
  ...
  /**
   * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] =
   * A[i,:] .* c[i] The Matrix <tt>A</tt> and array <tt>c</tt> do not need to
   * have the same dimensions, so long as they both have indices in the given
   * range.
   *
   * @param A
   *          the matrix to perform he update on
  ...
  /**
   * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] =
   * A[i,:] .* c[i] The Matrix <tt>A</tt> and vector <tt>c</tt> do not need to
   * have the same dimensions, so long as they both have indices in the given
   * range.
   *
   * @param A
   ...
   *          the last index of the row to update (exclusive)
   * @param c
   *          the vector of values to multiple the elements of <tt>A</tt> by
   */
   ...
   *          the second column to swap
   * @param start
   *          the first row that will be included in the swap (inclusive)
   * @param to
   *          the last row to be included in the swap (exclusive)
   */
   ...
   * @param start
   *          the first column that will be included in the swap (inclusive)
   * @param to
   *          the last column to be included in the swap (exclusive)
   */
