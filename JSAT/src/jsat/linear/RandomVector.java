 ...
 * <br>
 * Because the values of the random vector are computed on the fly, the Random Vector can not be altered. If attempted,
...
public abstract class RandomVector extends Vec {
  ...
  /**
   * Computes the value of an index given the already initialized {@link Random} object. This is called by the {@link #get(int)
   * }
