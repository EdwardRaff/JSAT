...
/**
 * The Cosine Distance is a adaption of the Cosine Similarity's range from [-1, 1] into the range [0, 1]. Where 0 means
 * two vectors are the same, and 1 means they are completely different.
 *
 * @author Edward Raff
 */
public class CosineDistance implements DistanceMetric {
  ...
  /**
   * This method converts the distance obtained with {@link #cosineToDistance(double) } back into the cosine angle
   *
