...
/**
 * This distance metric returns the same cosine distance as {@link CosineDistance}. This implementation assumes that all
 * vectors being passed in for distance computations have already been L2 normalized. This means the distance
 * computation can be done more efficiently, but the results will be incorrect if the inputs have not already been
 * normalized. <br>
 * The word Normalized is postfixed to the name to avoid confusion, as many might assume "Normalized-CosineDistance"
 * would mean a cosine distance with some form of additional normalization.
 *
 * @author Edward Raff
 */
