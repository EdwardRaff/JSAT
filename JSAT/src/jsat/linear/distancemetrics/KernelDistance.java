...
/**
 * Creates a distance metric from a given kernel trick. For the distance metric to be valid, the kernel used must be
 * positive definite.
 *
 * @author Edward Raff
 */
public class KernelDistance implements DistanceMetric {
  ...
  /**
   * Creates a distane metric from the given kernel. For the metric to be valid, the kernel must be positive definite.
   * This means that
   * <br><br>
   ...
   * <br><br>
   * Special Notes:<br>
   * The use of {@link RBFKernel} or {@link PolynomialKernel} of degree 1 in the {@link NearestNeighbour} classifier
   * will degenerate into the normal nearest neighbor algorithm.
   *
