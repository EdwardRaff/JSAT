...
/**
 * This data structure allows to wrap a Vector so that it is associated with some object time. Note, that operations
 * that return a vector will not be a Paired Vector, as there is no reason to associate a different vector with this
 * vector's pair.
 *
 * @author Edward Raff
 */
public class VecPaired<V extends Vec, P> extends Vec {
  ...
  /**
   * This method is used assuming multiple VecPaired are used together. The implementation of the vector may have logic
   * to handle the case that the other vector is of the same type. This will go through every layer of VecPaired to
