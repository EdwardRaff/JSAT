...
/**
 * This class provides a free view of the transpose of a matrix. This is done by accessing the matrix elements in
 * swapped order. This has a serious performance impact. If the base matrix storage is row major order, then accessing
 * the TransposeView in column major order will provide the best performance.
 *
 * @author Edward Raff
 */
