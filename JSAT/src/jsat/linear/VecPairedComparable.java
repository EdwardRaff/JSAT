 ...
 * @author Edward Raff
 */
public class VecPairedComparable<V extends Vec, P extends Comparable<P>> extends VecPaired<V, P>
    implements Comparable<VecPairedComparable<V, P>> {
  ...
  public int compareTo(final VecPairedComparable<V, P> o) {
    return getPair().compareTo(o.getPair());
  }
}
