...
/**
 * Utility class for using {@link VecPaired} when the paired value is comparable , and the vectors need to be sorted
 * based on their paired value. This class performs exactly the same, and its only modification is that it is comparable
