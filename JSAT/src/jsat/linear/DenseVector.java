...
/**
 * A vector implementation that is dense, meaning all values are allocated - even if their values will be implicitly
 * zero.
 *
 * @author Edward Raff
 */
public class DenseVector extends Vec {
  ...
  /**
   * Creates a new Dense Vector that uses the given array as its values. Its values will not be copied, and raw access
   * and mutations tot he given array may occur.
   *
   ...
   * @param start the first index in the array, inclusive, to mark the start of the vector.
   * @param end the last index in the array, exclusive, to mark the end of the vector.
   */
  ...
  /**
   * Returns a new dense vector backed by the given array. This is a weak reference, the given array should no longer be
   * altered - as it will effect the values of the dense vector.
   *
