...
/**
 * A Vector Collection is a collection of vectors that is meant to be used to obtain a subset of the collection via a
 * query vector. A query can be for the nearest neighbors, or for all vectors within a given range.
 * <br>
...
public interface VectorCollection<V extends Vec> extends Cloneable, Serializable {
   ...
   * @return the list of all vectors within the range of our query. The paired value contains the distance to the query
   * vector.
   */
   ...
   * @return the list the k nearest neighbors, in sorted order from closest to farthest. The paired value contains the
