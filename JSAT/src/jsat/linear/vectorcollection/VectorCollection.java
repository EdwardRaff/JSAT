...
public interface VectorCollection<V extends Vec> extends Cloneable, Serializable {
  ...
  /**
   * Searches the space for all vectors that are within a given range of the
   * query vector.
   *
   * @param query
   *          the vector we want to find others near
   * @param range
   *          the search range around our query
