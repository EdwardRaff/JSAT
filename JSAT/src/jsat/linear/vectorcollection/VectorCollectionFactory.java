...
public interface VectorCollectionFactory<V extends Vec> extends Cloneable, Serializable {
  ...
  /**
   * Creates a new Vector Collection from the given source using the provided
   * metric.
   *
   * @param source
   *          the list of vectors to put into the collection.
   * @param distanceMetric
   *          the distance measure to use for the space
