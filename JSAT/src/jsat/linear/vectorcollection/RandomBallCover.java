...
/**
 * An implementation of the exact search for the Random Ball Cover algorithm. Unlike most algorithms, it attempts to
 ...
 * Unlike the original paper, which assumes single queries will be run in parallel, the algorithm has been modified to
 * perform additional pruning and to support range queries.
 * <br><br>
 * See: Cayton, L. (2012). <i>Accelerating Nearest Neighbor Search on Manycore Systems</i>. 2012 IEEE 26th International
 * Parallel and Distributed Processing Symposium, 402–413. doi:10.1109/IPDPS.2012.45
 *
 * @author Edward Raff
 */
public class RandomBallCover<V extends Vec> implements VectorCollection<V> {
  ...
  /**
   * The indices match with their representatives in R and in ownedVecs. Each value indicates the distance of the point
   * to its owner. They are not in any order
   */
