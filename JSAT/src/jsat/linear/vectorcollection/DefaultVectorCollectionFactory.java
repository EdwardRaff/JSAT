...
/**
 * DefaultVectorCollectionFactory is a generic factory that attempts to return a good vector collection for the given
 * input. It may take into account the size of the data set, dimensions, and the distance metric in use to select a
