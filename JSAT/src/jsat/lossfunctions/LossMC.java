 ...
 * <br>
 * Calling {@link #process(jsat.linear.Vec, jsat.linear.Vec) } on the raw scores
...
public interface LossMC extends LossC {
  ...
  /**
   * Computes the derivatives with respect to each output <br>
   ...
   * @param derivs
   *          the vector to place the derivative of the loss to.
   * @param y
   *          the true class label in [0, k-1] for <i>k</i> classes
   */
   ...
   *
   * @param processed
   *          the processed score/prediction vector
   ...
   *          the vector of raw predictions
   * @param processed
   *          the location to store the processed predictions.
   */
