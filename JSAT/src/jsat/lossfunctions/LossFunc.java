...
public interface LossFunc extends Serializable {
   ...
   * @param y
   *          the true value in (-Infinity, Infinity)
   ...
   * the second derivative does not exist, {@link Double#NaN} is a valid result.
   * It is also possible for {@code 0} and {@link Double#POSITIVE_INFINITY} to
   * be valid results, and must be checked for.
   *
   ...
   *
   * @param pred
   *          the predicted value in (-Infinity, Infinity)
   * @param y
   *          the true value in (-Infinity, Infinity)
