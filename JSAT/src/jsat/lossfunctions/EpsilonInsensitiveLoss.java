...
/**
 * The &epsilon;-insensitive loss for regression <i>L(x, y) = max(0,
 * |x-y|-&epsilon;)</i> is the common loss function used for Support Vector
 * Regression. <br>
...
public class EpsilonInsensitiveLoss implements LossR {
   ...
   *
   * @param eps
   *          the epsilon tolerance on error
   */
