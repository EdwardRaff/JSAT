...
/**
 * The MeanShift algorithms performs clustering on a data set by letting the data speak for itself and performing a mode
 * search amongst the data set, returning a cluster for each discovered mode. <br>
 * <br>
 * While not normally discussed in the context of Mean Shift, this implementation has rudimentary outlier-removal,
 * outliers will not be included in the clustering. <br>
 * <br>
 * The mean shift requires a {@link MultivariateKDE} to run. Contrary to use in density estimation, where the
 * {@link KernelFunction} used has only a minor impact on the results, it is highly recommended you use the
 * {@link GaussKF} for the MeanShift method. This is because of the large support and better behaved derivative, which
 * adds in the avoidance of oscillating convergence.
 * <br><br>
 * Implementation Note: This implementation does not snap the values to a grid. This causes the prior noted oscillation
 * in convergence.
 *
 * @author Edward Raff
 */
public class MeanShift extends ClustererBase {
  ...
  /**
   * Creates a new MeanShift clustering object using a {@link MetricKDE}, the {@link GaussKF}, and the
  ...
  /**
   * Creates a new MeanShift clustering object using a {@link MetricKDE} and the {@link GaussKF}.
   *
  ...
  /**
   * Sets the maximum number of iterations the algorithm will go through, terminating early if convergence has not
   * occurred.
   *
  ...
  /**
   * Returns the maximum number of iterations the algorithm will go through, terminating early if convergence has not
   * occurred.
   *
  ...
  /**
   * Sets the value by which the bandwidth of the {@link MultivariateKDE} will be scaled by.
   *
  ...
  /**
   * Returns the value by which the bandwidth of the {@link MultivariateKDE} will be scaled by.
   *
  ...
  /**
   * Computes the meanShift of the point at the given index, and then updates the vector array to indicate the movement
   * towards the mode for the data point.
   *
