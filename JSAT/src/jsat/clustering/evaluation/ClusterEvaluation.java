 ...
 * clusters, instead of just measuring the dissimilarity of two specific
 * clusters.
 *
 * @author Edward Raff
 */
public interface ClusterEvaluation {
   ...
   *
   * @param designations
   *          the array that stores the cluster assignments for each data point
   *          in the data set
   * @param dataSet
   *          the data set that contains all data points
   ...
   *
   * @param dataSets
   *          a list of lists, where the size of the first index indicates the
   *          the number of clusters, and the list at each index is the data
   *          points that make up each cluster.
   * @return a value in [0, Inf) that indicates the quality of the clustering.
   */
