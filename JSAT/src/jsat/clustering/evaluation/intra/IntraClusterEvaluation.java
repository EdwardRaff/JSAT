...
/**
 * This interface defines the contract for a method to evaluate the intra-cluster distance. This means an evaluation of
 * a single cluster, where a higher value indicates a poorly formed cluster. This evaluation does not take into account
 * any other neighboring clusters
 *
 * @author Edward Raff
 */
public interface IntraClusterEvaluation {
   ...
   * @param clusterID the cluster id in the <tt>designations</tt> array to return the evaluation of
   * @return the value in the range [0, Inf) that indicates how well formed the cluster is.
   */
