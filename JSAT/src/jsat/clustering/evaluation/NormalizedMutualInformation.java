 ...
 * set. The NMI normally returns a value in [0, 1], where 0 indicates the clustering appears random, and 1 indicate the
 * clusters perfectly match the class labels. To match the {@link ClusterEvaluation} interface, the value returned by
 * evaluate will be 1.0-NMI .
 * <br>
 * <b>NOTE:</b> Because the NMI needs to know the true class labels, only {@link #evaluate(int[], jsat.DataSet) } will
