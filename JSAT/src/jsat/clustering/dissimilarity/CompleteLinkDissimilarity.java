...
/**
 * Measures the dissimilarity of two clusters by returning the value of the maximal dissimilarity of any two pairs of
 * data points where one is from each cluster.
 *
 * @author Edward Raff
 */
