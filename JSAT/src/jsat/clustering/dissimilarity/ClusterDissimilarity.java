...
/**
 * This interface provides the basic contract for measuring the dissimilarity between two clusters, and intended for use
...
public interface ClusterDissimilarity {
   ...
   * @return a value &gt;= 0 that is a measure of the difference between the two points. The closer to zero, the more
   ...
   * is done using a matrix containing all pairwise distance computations between all points.
   *
   * @param a the first set of indices of the original data set that are in a cluster, which map to
   * <i>distanceMatrix</i>
   * @param b the second set of indices of the original data set that are in a cluster, which map to
   * <i>distanceMatrix</i>
