 ...
 * <br><br>
 * See paper:<br>
 * <a href="http://www.springerlink.com/index/0116171485446868.pdf">Biçici, E., &amp;Yuret, D. (2007). Locally scaled
 * density based clustering. In B. Beliczynski, A. Dzielinski, M. Iwanowski,&amp;B. Ribeiro (Eds.), Adaptive and Natural
 * Computing Algorithms (pp. 739–748). Warsaw, Poland: Springer-Verlag. </a>
 *
 * @author Edward Raff
 */
public class LSDBC extends ClustererBase implements Parameterized {
  ...
  /**
   * Creates a new LSDBC clustering object using the {@link EuclideanDistance} and default parameter values.
   */
  public LSDBC() {
  ...
  /**
   * Sets the scale value that will control how many points are added to a cluster. Smaller values will create more,
   * smaller clusters - and more points will be labeled as noise. Larger values causes larger and fewer clusters.
   *
  ...
  /**
   * Returns the scale value that will control how many points are added to a cluster. Smaller values will create more,
   * smaller clusters - and more points will be labeled as noise. Larger values causes larger and fewer clusters.
   *
