...
public class OPTICS extends ClustererBase implements Parameterized
{
    ...
    {{
        add(new ObjectParameter<ExtractionMethod>() {

                @Override
                public ExtractionMethod getObject()
                {
                    return getExtractionMethod();
                }

                @Override
                public boolean setObject(ExtractionMethod obj)
                {
                    setExtractionMethod(obj);
                    return true;
                }

                @Override
                public List<ExtractionMethod> parameterOptions()
                {
                    return Arrays.asList(ExtractionMethod.values());
                }
