...
public class CLARA extends PAM
{
    ...
    public CLARA(final int sampleSize, final int sampleCount, final DistanceMetric dm, final Random rand, final SeedSelection seedSelection)
    {
    ...
    @Override
    protected double cluster(final DataSet data, final boolean doInit, final int[] medioids, final int[] assignments, List<Double> cacheAccel)
    {
