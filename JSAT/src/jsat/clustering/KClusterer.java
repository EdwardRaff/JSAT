...
public interface KClusterer extends Clusterer {
   ...
   * @return A list of DataSets, where each DataSet contains the data points for
   *         one cluster in the group
   */
  ...
  /**
   * Performs clustering on the given data set. The implementation will attempt
   * to determine the best number of clusters for the given data.
   *
   * @param dataSet
   *          the data points to perform clustering on
   * @param lowK
   ...
   * @param highK
   *          the upper bound, inclusive, of the range to search
   * @return A list of DataSets, where each DataSet contains the data points for
   *         one cluster in the group
   */
