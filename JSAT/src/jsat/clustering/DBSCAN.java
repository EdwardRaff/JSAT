...
/**
 * A density-based algorithm for discovering clusters in large spatial databases with noise (1996) by Martin Ester ,
 * Hans-peter Kriegel , Jörg S , Xiaowei Xu
 *
 * @author Edward Raff
 */
public class DBSCAN extends ClustererBase {
  ...
  /**
   * Factory used to create a vector space of the inputs. The paired Integer is the vector's index in the original
   * dataset
   */
