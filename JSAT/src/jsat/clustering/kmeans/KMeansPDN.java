 ...
 * works by incrementing the value of {@code k} up to some specified maximum, and running a full KMeans for each value.
 * <br>
 * <br>
 ...
 * constructed with.
 *
 * See: Pham, D. T., Dimov, S. S.,&amp;Nguyen, C. D. (2005). <i>Selection of K in K-means clustering</i>. Proceedings of
 * the Institution of Mechanical Engineers, Part C: Journal of Mechanical Engineering Science, 219(1), 103–119.
...
public class KMeansPDN extends KMeans {
  ...
  /**
   * Returns the array of {@code f(K)} values generated for the last data set. The value at index {@code i} is the score
   * for cluster {@code i+1}. Smaller values indicate better clusterings.
   *
   * @return the array of {@code f(K)} values, or {@code null} if no data set has been clustered
   */
