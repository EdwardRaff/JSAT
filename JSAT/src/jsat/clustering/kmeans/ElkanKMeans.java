...
public class ElkanKMeans extends KMeans {
  ...
  /**
   * Sets whether or not to use {@link DenseSparseMetric } when computing. This may or may not provide a speed increase.
   *
   * @param useDenseSparse whether or not to compute the distance from dense mean vectors to sparse ones using
   * acceleration
   */
