...
/**
 * The Majority Vote classifier is a simple ensemble classifier. Given a list of base classifiers, it will sum the most
 * likely votes from each base classifier and return a result based on the majority votes. It does not take into account
 * the confidence of the votes.
 *
 * @author Edward Raff
 */
public class MajorityVote implements Classifier {
  ...
  /**
   * Creates a new Majority Vote classifier using the given voters. If already trained, the Majority Vote classifier can
   * be used immediately. The MajorityVote does not make copies of the given classifiers. <br>
