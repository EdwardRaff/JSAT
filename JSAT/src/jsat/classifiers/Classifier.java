...
public interface Classifier extends Cloneable, Serializable {
   ...
   *           if the method is called before the model has been trained
   * @throws ModelMismatchException
   *           if the given data point is incompatible with the model
   */
   ...
   * If it does, the model will train assuming the weights. The values returned
   * by this method may change depending on the parameters set for the model.
   *
   ...
   *           if the model is unable to be constructed for some reason
   */
