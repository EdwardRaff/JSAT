...
/**
 * Implements the iterative and single threaded stochastic solver for L
 * <sub>1</sub> regularized linear regression problems SMIDAS (Stochastic Mirror
 * Descent Algorithm mAde Sparse). It performs very well when the number of
 * features is large relative to or greater than the number of data points. It
 * also works decently on smaller sparse data sets. <br>
