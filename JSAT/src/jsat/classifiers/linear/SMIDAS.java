...
/**
 * Implements the iterative and single threaded stochastic solver for L<sub>1</sub> regularized linear regression
 * problems SMIDAS (Stochastic Mirror Descent Algorithm mAde Sparse). It performs very well when the number of features
 ...
 * [0,1] to preserve sparseness. If your data is dense or has negative and positive feature values, scaling to [-1, 1]
