...
public class LinearTools {
   ...
   * the smallest value of lambda that produces a weight vector of all zeros.<br>
   * <br>
   * Note, that the value returned depends on the data set size. If being used to initialize the value of &lambda; for
   * cross validation with k-folds, the value (k-1)/k * &lambda; will be closer to the correct value of &lambda; for
   * each CV set.
   *
  ...
  public static double maxLambdaLogisticL1(ClassificationDataSet cds) {
    /**
     * This code was ripped out/modified from NewGLMNET. It follows the strategy laid out in Schmidt, M., Fung,
     * G.,&amp;Rosaless, R. (2009). Optimization Methods for L1-Regularization. Retrieved from
     * http://www.cs.ubc.ca/cgi-bin/tr/2009/TR-2009-19.pdf , where we use the coordinate with the largest magnitude of
     * the gradient
     */
    /**
