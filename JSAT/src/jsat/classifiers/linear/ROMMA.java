...
/**
 * Provides an implementation of the linear Relaxed online Maximum Margin algorithm, which finds a similar solution to
 * SVMs. By default, the aggressive variant with an implicit bias term is used, which is the suggested form from the
 * paper. It is a binary classifier.
 * <br><br>
 * See: Li, Y.,&amp;Long, P. M. (2002). <i>The Relaxed Online Maximum Margin Algorithm</i>. Machine Learning, 46(1-3),
 * 361–387. doi:10.1023/A:1012435301888
 *
 * @author Edward Raff
 */
