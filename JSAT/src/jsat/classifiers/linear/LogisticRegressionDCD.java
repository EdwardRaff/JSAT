...
/**
 * This provides an implementation of regularized logistic regression using Dual Coordinate Descent. This algorithm
 * works well on both dense and sparse large data sets.
 * <br><br>
 * The regularized problem is of the form:<br>
 * C <big>&Sigma;</big> log(1+exp(-y<sub>i</sub>w<sup>T</sup>x<sub>i</sub>)) + w<sup>T</sup>w/2
 * <br><br>
 * See:<br>
 * Yu, H.-F., Huang, F.-L.,&amp;Lin, C.-J. (2010). <i>Dual Coordinate Descent Methods for Logistic Regression and
 * Maximum Entropy Models</i>. Machine Learning, 85(1-2), 41–75. doi:10.1007/s10994-010-5221-8
 *
 * @author Edward Raff
 */
public class LogisticRegressionDCD implements Classifier, Parameterized, SingleWeightVectorModel {
  ...
  /**
   * Creates a new Logistic Regression learner that does no more than 100 training iterations with a default
   * regularization tradeoff of C = 1
   */
  ...
  /**
   * Sets the regularization trade-off term. larger values reduce the amount of regularization, and smaller values
