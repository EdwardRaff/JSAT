 ...
 * Its a type of online algorithm that performs the minimal update necessary to correct for a mistake.
 * <br><br>
 * See:<br>
 * Crammer, K., Dekel, O., Keshet, J., Shalev-Shwartz, S.,&amp;Singer, Y. (2006).
 * <a href="http://dl.acm.org/citation.cfm?id=1248566">
 * <i>Online passive-aggressive algorithms</i></a>. Journal of Machine Learning Research, 7, 551–585.
 *
 * @author Edward Raff
 */
public class PassiveAggressive implements UpdateableClassifier, BinaryScoreClassifier, UpdateableRegressor, Parameterized, SingleWeightVectorModel {
  ...
  /**
   * Creates a new Passive Aggressive learner that does 10 epochs and uses {@link Mode#PA1}
   */
  ...
  public static enum Mode {
    /**
     * The default Passive Aggressive algorithm, it performs correction updates that make the minimal change necessary
     * to correct the output for a single input
     */
    PA,
    /**
    ...
    PA1,
    /**
     * Limits the aggressiveness by adding a constant factor to the denominator of the correction.
     */
    PA2
  }
  ...
  /**
   * Guess the distribution to use for the regularization term {@link #setC(double) C} in PassiveAggressive.
   *
