...
/**
 * This is the general class object for representing a singular data point in a
 * data set. Every data point is made up of either categorical variables,
 * numerical variables, or a combination of the two.
 *
 * @author Edward Raff
 */
public class DataPoint implements Cloneable, Serializable {
   ...
   *          a vector containing the numerical values for this data point
   */
   ...
   *          a vector containing the numerical values for this data point
   * @param weight
   *          a double indicating how much weight this data point has, 1.0 being
   *          the standard weight. Not all algorithms make use of data points
   ...
   *          an array of the category values for this data point
   * @param categoricalData
   *          an array of the category information of this data point
   */
  ...
  /**
   * Creates a deep clone of this data point, such that altering either data
   * point does not effect the other one.
   *
   * @return a deep clone of this data point.
   */
  @Override
  public DataPoint clone() {
    return new DataPoint(numericalValues.clone(), Arrays.copyOf(categoricalValues, categoricalValues.length),
        CategoricalData.copyOf(categoricalData), weight);
  }

  /**
   * Returns true if this data point contains any categorical variables, false
   * otherwise.
   *
   * @return true if this data point contains any categorical variables, false
   *         otherwise.
   */
  ...
  /**
   * Returns true if the data point contains any numerical variables, false
   * otherwise.
   *
   * @return true if the data point contains any numerical variables, false
   *         otherwise.
   */
  ...
  /**
   * Returns the array of values for each category. Altering this array will
   * effect this data point. If changes are going to be made, a clone of the
   * array should be made by the caller.
   *
  ...
  /**
   * Returns the vector containing the numerical values. Altering this vector
   * will effect this data point. If changes are going to be made, a clone of
   * the vector should be made by the caller.
   *
   ...
   *           if the weight value is not a number &gt; 0
   */
