...
/**
 * This is the general class object for representing a singular data point in a data set. Every data point is made up of
 * either categorical variables, numerical variables, or a combination of the two.
 *
 * @author Edward Raff
 */
public class DataPoint implements Cloneable, Serializable {
   ...
   * @param categoricalValues an array of the category values for this data point
   * @param categoricalData an array of the category information of this data point
   * @param weight a double indicating how much weight this data point has, 1.0 being the standard weight. Not all
   * algorithms make use of data points that have different weights.
   */
  ...
  /**
   * Returns the vector containing the numerical values. Altering this vector will effect this data point. If changes
   * are going to be made, a clone of the vector should be made by the caller.
   *
  ...
  /**
   * Returns the array of values for each category. Altering this array will effect this data point. If changes are
   * going to be made, a clone of the array should be made by the caller.
   *
