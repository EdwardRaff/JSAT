...
/**
 * Platt Calibration essentially performs logistic regression on the output scores of a model against their class
 * labels. While first described for SVMs, Platt's method can be used for any scoring algorithm in general.
 * <br><br>
 * See:<br>
 * <ul>
 * <li>Platt, J. C. (1999). <i>Probabilistic Outputs for Support Vector Machines and Comparisons to Regularized
 * Likelihood Methods</i>. Advances in Large Margin Classifiers (pp. 61–74). MIT Press. Retrieved from
 * <a href="http://www.tu-harburg.de/ti6/lehre/seminarCI/slides/ws0506/SVMprob.pdf">
 * here </a></li>
 * <li>Lin, H.-T., Lin, C.-J.,&amp;Weng, R. C. (2007). <i>A note on Platt’s probabilistic outputs for support vector
 * machines</i>. Machine learning, 68(3), 267–276. Retrieved from
 * <a href="http://www.springerlink.com/index/8417V9235M561471.pdf">here</a></li>
 * <li>Niculescu-Mizil, A.,&amp;Caruana, R. (2005). <i>Predicting Good Probabilities with Supervised Learning</i>.
 * International Conference on Machine Learning (pp. 625–632). Retrieved from
