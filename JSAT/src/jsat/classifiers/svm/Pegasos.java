 ...
 * saved from the training set. <br>
 * <br>
...
public class Pegasos implements BinaryScoreClassifier, Parameterized, SingleWeightVectorModel {
  ...
  public Pegasos(final Pegasos toCopy) {
    ...
    bias = toCopy.bias;
    projectionStep = toCopy.projectionStep;
  }
   ...
   *
   * @param batchSize
   *          the number of data points to use when updating
   */
   ...
   * iteration
   *
   * @param projectionStep
   *          whether or not to use the projection step
   */
