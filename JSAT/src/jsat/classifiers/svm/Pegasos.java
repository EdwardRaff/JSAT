...
/**
 * Implements the linear kernel mini-batch version of the Pegasos SVM classifier. It performs updates stochastically and
 * is very fast. <br>
 ...
 * SVM</i>. 24th international conference on Machine learning (pp. 807–814). New York, NY: ACM.
...
public class Pegasos implements BinaryScoreClassifier, Parameterized, SingleWeightVectorModel {
  ...
  /**
   * Sets the batch size used during training. At each epoch, a batch of randomly selected data points will be used to
   * update.
   *
  ...
  /**
   * Guess the distribution to use for the regularization term {@link #setRegularization(double) } in Pegasos.
   *
