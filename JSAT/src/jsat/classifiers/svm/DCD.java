...
/**
 * Implements Dual Coordinate Descent (DCD) training algorithms for a Linear L
 * <sup>1</sup> or L<sup>2</sup> Support Vector Machine for binary
 ...
 * S. (2008). <i>A Dual Coordinate Descent Method for Large-scale Linear SVM</i>
...
public class DCD implements BinaryScoreClassifier, Regressor, Parameterized, SingleWeightVectorModel {
  ...
  public DCD clone() {
    ...
    clone.onlineVersion = onlineVersion;
    clone.bias = bias;
  ...
  /**
   * Returns whether or not the online version of the algorithm, algorithm 2 is
   * in use.
   *
   * @return <tt>true</tt> if algorithm 2 is in use, <tt>false</tt> if algorithm
   *         1
   */
   ...
   *          the value of U
   * @param Qh_ii
   *          the Q hat value that will be used in this update.
   */
   ...
   *
   * @param onlineVersion
   *          <tt>false</tt> to use algorithm 1, <tt>true</tt> to use algorithm
   *          2
   */
