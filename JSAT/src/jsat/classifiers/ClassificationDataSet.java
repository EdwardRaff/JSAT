...
/**
 * ClassificationDataSet is a data set meant specifically for classification problems. The true class of each data point
 * is stored separately from the data point, so that it can be feed into a learning algorithm and not interfere.
 * <br>
...
public class ClassificationDataSet extends DataSet<ClassificationDataSet> {
  ...
  /**
   * Creates a new data set for classification problems from the given list of data points. It is assume the data points
   * are consistent.
   *
  ...
  /**
   * Creates a new data set for classification problems from the given list of data points. The class value is paired
  ...
  /**
   * Returns the number of target classes in this classification data set. This value can also be obtained by calling
   * {@link #getPredicting() getPredicting()}. {@link CategoricalData#getNumOfCategories() getNumOfCategories() }
   *
  ...
  /**
   * A helper method meant to be used with {@link #cvSet(int) }, this combines all classification data sets in a given
   * list, but holding out the indicated list.
   *
  ...
  /**
   * This method is a counter part to {@link #getNumericColumn(int) }. Instead of returning all values for a given
   * attribute, all values for the attribute that are members of a specific class are returned.
   *
   * @param category the category desired
  ...
  /**
   * Returns the data set as a list of {@link DataPointPair}. Each data point is paired with it's true class value.
   * Altering the data points will effect the data set. Altering the list will not. <br>
   * The list of data points will come in the same order they would be retrieved in using {@link #getDataPoint(int) }
   *
  ...
  /**
   * Returns the data set as a list of {@link DataPointPair}. Each data point is paired with it's true class value,
   * which is stored in a double. Altering the data points will effect the data set. Altering the list will not. <br>
   * The list of data points will come in the same order they would be retrieved in using {@link #getDataPoint(int) }
   *
  ...
  /**
   * Returns the number of data points that belong to the specified class, irrespective of the weights of the individual
   * points.
   *
