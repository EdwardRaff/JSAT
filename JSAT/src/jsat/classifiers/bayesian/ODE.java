...
/**
 * One-Dependence Estimators (ODE) is an extension of Naive Bayes that, instead of assuming all features are
 * independent, assumes all features are dependent on one other feature besides the target class. Because of this extra
 * dependence requirement, the implementation only allows for categorical features.
 * <br>
...
public class ODE extends BaseUpdateableClassifier {
   ...
   * @return the non normalized log probability of the data point belonging to the target class <tt>c</tt>
   */
