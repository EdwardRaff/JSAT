...
public class CategoricalData implements Cloneable, Serializable {
  ...
  /**
   * Sets the name of one of the value options. Duplicate names are not allowed. Trying to set the name of a non
   * existent option will result in false being returned.
   * <br>
