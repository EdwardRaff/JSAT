...
/**
 * This is an implementation of the Multi-Class AdaBoost method SAMME (Stagewise Additive Modeling using a Multi-Class
 * Exponential loss function), presented in <i>Multi-class AdaBoost</i> by Ji Zhu, Saharon Rosset, Hui Zou,&amp;Trevor
 * Hasstie <br>
 * <br>
 * This algorithm reduces to {@link AdaBoostM1 } for binary classification problems. Its often performs better for
 * <i>k</i> class classification problems, and has a weaker requirement of besting 1/<i>k</i>
