...
/**
 * Modest Ada Boost is a generalization of Discrete Ada Boost that attempts to reduce the generalization error and avoid
 * over-fitting. Empirically, ModestBoost usually maintains a higher training-set error, and may take more iterations to
 * obtain the same test set error as other algorithms, but doesn't not increase as much after it reaches the minimum
 * error - which should make it easier to obtain the higher accuracy.
 * <br>
 * See: <br>
 * Vezhnevets, A.,&amp;Vezhnevets, V. (2005). <i>“Modest AdaBoost” – Teaching AdaBoost to Generalize Better</i>.
 * GraphiCon. Novosibirsk Akademgorodok, Russia. Retrieved from
