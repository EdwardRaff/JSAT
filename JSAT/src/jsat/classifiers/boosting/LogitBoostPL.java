...
/**
 * An extension to the original LogitBoost algorithm for parallel training. This comes at an increase in classification
 * time.
 * <br>
 * Note: LogitBoost is a semi unstable algorithm, and this method does in fact increase the instability. In most cases,
 * similar classification results will be obtained, however - under some circumstances the performance may be
 * significantly degraded. Especially if there is insufficient data to distribute for parallel computation. The results
 * for LogitBoost seem to be over stated in the original paper.
 * <br>
 * See: <i>Scalable and Parallel Boosting with MapReduce</i>, Indranil Palit and Chandan K. Reddy, IEEE Transactions on
