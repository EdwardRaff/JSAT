...
/**
 * Arc-x4 is a ensemble-classifier that performs re-weighting of the data points based on the total number of errors
 * that have occurred for the data point.
 * <br><br>
 * See: Breiman, L. (1998). <i>Arcing Classifiers</i>. The Annals of Statistics, 26(3), 801–824.
 *
 * @author Edward Raff
 */
public class ArcX4 implements Classifier, Parameterized {
  ...
  /**
   * Weights are updated as 1+coef*errors<sup>expo</sup>. This sets the coefficient used to update the errors
   *
  ...
  /**
   * Weights are updated as 1+coef*errors<sup>expo</sup>. This sets the exponent used to update the errors
   *
