...
/**
 * Wagging is a meta-classifier that is related to {@link Bagging}. Instead training on re-sampled data sets, it trains
 * on randomly re-weighted data sets. The weight of each point is selected at random from a specified distribution, and
 * set to zero if negative.
 * <br><br>
 * See: <a href="http://www.springerlink.com/index/L006M1614W023752.pdf">
 * Bauer, E.,&amp;Kohavi, R. (1999). <i>An empirical comparison of voting classification algorithms</i>: Bagging,
 * boosting, and variants. Machine learning, 38(1998), 1–38.</a>
 *
 * @author Edward Raff
 */
