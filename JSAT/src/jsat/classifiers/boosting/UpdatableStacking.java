...
public class UpdatableStacking implements UpdateableClassifier, UpdateableRegressor {
  ...
  public UpdatableStacking(final UpdatableStacking toCopy) {
    ...
    if (toCopy.aggregatingClassifier != null) {
      ...
      baseClassifiers = new ArrayList<UpdateableClassifier>(toCopy.baseClassifiers.size());
    ...
    } else// we are doing with regressors only
    {
      ...
      baseRegressors = new ArrayList<UpdateableRegressor>(toCopy.baseRegressors.size());
   ...
   */
  public UpdatableStacking(final UpdateableClassifier aggregatingClassifier,
      final List<UpdateableClassifier> baseClassifiers) {
   ...
   */
  public UpdatableStacking(final UpdateableClassifier aggregatingClassifier,
      final UpdateableClassifier... baseClassifiers) {
   ...
   */
  public UpdatableStacking(final UpdateableRegressor aggregatingRegressor,
      final List<UpdateableRegressor> baseRegressors) {
   ...
   */
  public UpdatableStacking(final UpdateableRegressor aggregatingRegressor,
      final UpdateableRegressor... baseRegressors) {
   ...
   *
   * @param data
   *          the data point to get the classifier from
   * @param weight
   *          the weight to use for the data point object
  ...
  public void setUp(final CategoricalData[] categoricalAttributes, final int numericAttributes,
    ...
    // set up all models, agregating gets different arugmetns since it gets the
    // created input from the base models
