...
/**
 * The F<sub>&beta;</sub> score is the generalization of {@link F1Score}, where &beta; indicates the level of preference
 * for precision over recall. This score is only valid for binary classification problems.
 *
 * @author Edward Raff
 */
public class FbetaScore extends SimpleBinaryClassMetric {
   ...
   *
   * @param beta the weight to apply to precision over recall, must be in (0, &infin;)
   */
