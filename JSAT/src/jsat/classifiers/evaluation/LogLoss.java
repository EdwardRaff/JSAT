...
public class LogLoss implements ClassificationScore {
   ...
   *
   * @param nudge
   *          the nudge value to avoid zero probabilities, must be non negative
   *          and less than 0.1
   */
  public LogLoss(final double nudge) {
  ...
  public LogLoss(final LogLoss toClone) {
    loss = toClone.loss;
    weightSum = toClone.weightSum;
    nudge = toClone.nudge;
  }
  ...
  public void addResults(final ClassificationScore other) {
    final LogLoss otherObj = (LogLoss) other;
    loss += otherObj.loss;
    weightSum += otherObj.weightSum;
  }
  ...
  public boolean equals(final Object obj) {
    if (this.getClass().isAssignableFrom(obj.getClass()) && obj.getClass().isAssignableFrom(this.getClass())) {
      return ((LogLoss) obj).nudge == nudge;
    }
    return false;
  }
