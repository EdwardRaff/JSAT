...
public class CategoricalResults implements Cloneable {
  ...
  /**
   * Creates a new Categorical Result using the given array. It will use only a reference to the given array, and will
   * assume the values are already normalized and sum to one.
   *
