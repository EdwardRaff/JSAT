...
/**
 * Decision Directed Acyclic Graph (DDAG) classifier. DDAG extends binary decision classifiers into multi-class decision
 * classifiers. Unlike {@link OneVSOne}, DDAG results are hard classification decisions, and will not give probabilistic
 * estimates. Accuracy is often very similar, but DDAG classification speed can be significantly faster, as it does not
 * evaluate all possible combinations of classifiers.
 *
 * @author Edward Raff
 */
