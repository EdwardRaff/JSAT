...
/**
 * This initializer samples the weights from an adjusted uniform distribution in order to provided better behavior of
 * neuron activation and gradients<br>
 * <br>
 * See: Glorot, X., &amp; Bengio, Y. (2010). <i>Understanding the difficulty of training deep feedforward neural
 * networks</i>. Journal of Machine Learning Research - Proceedings Track, 9, 249–256. Retrieved from
