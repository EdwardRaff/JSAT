...
public interface WeightRegularizer extends Serializable {
   ...
   *
   * @param W
   *          the matrix to apply regularization to
   * @param b
   ...
   *
   * @param w
   *          the weight row to be altered depending on the regularization
   *          method
   * @param b
   *          the original bias input to this row
   * @return the new bias value, or the same value if no change in the bias has
   *         occurred
   */
