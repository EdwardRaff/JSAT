...
/**
 * Provides a simple representation of bag-of-word vectors by simply using the number of occurrences for a word in a
 * document as the weight for said word.
 * <br>
 * <br>
 * WordCount needs no initialization, and can be applied as soon as the object is created.
 *
 * @author Edward Raff
 */
