...
/**
 * Provides a simple binary representation of bag-of-word vectors by simply marking a value 1.0 if the token is present,
 * and 0.0 if the token is not present. Nothing else is taken into account.
 *
 * @author Edward Raff
 */
