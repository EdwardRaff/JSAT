...
public class PaiceHuskStemmer extends Stemmer {
  ...
  static private class Rule {
    ...
    /**
     * Indicates that this rule may only be applied if the word has not been modified before
     */
    ...
    /**
     * If valid, returns the modified input string based on this rule. If no modification was done, the exact same
     * string that was passed in is returned. An object comparison can then be done to check if the string was modified.
     * <br>
