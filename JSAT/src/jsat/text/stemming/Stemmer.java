...
/**
 * Stemmers are algorithms that attempt reduce strings to their common stem or root word. For example, a stemmer might
 * idly reduce "runs" "running" and "ran" to the single stem word "run". This reduces the feature space size, and allows
 * multiple words that have the same meaning to be counted together.
 * <br>
 * Do not expect perfect results from stemming. This class provides the contract for a stemmer that does not have any
 * word history.
 *
 * @author Edward Raff
 */
