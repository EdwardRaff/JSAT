...
/**
 * This tokenizer wraps another such that any stop words that would have been returned by the base tokenizer are
 * removed. The stop list is case sensitive.
 *
 * @author Edward Raff
 */
public class StopWordTokenizer implements Tokenizer {
   ...
   * @param stopWords the collection of stop words to remove from tokenizations. A copy of the collection will be made
   */
  ...
  /**
   * This unmodifiable set contains a very small and simple stop word list for English based on the 100 most common
   * English words and includes all characters. All tokens the set are lowercase. <br>
   * This stop list is not meant to be authoritative or complete, but only a reasonable starting point that shouldn't
   * degrade any common tasks. <br>
   * <br>
