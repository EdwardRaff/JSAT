 ...
 * This extension uses {@link #addOriginalDocument(java.lang.String, int) } instead so that the original documents have
 * a class label associated with them. {@link #getDataSet() } then returns a classification data set, where the class
 * label for each data point is the label provided when {@code addOriginalDocument} was called.
 * <br>
