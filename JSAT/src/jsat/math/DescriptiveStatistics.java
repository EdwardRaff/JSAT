...
public class DescriptiveStatistics {
  ...
  /**
   * Computes the sample correlation coefficient for two data sets X and Y. The lengths of X and Y must be the same, and
   * each element in X should correspond to the element in Y.
   *
