...
/**
 * Implementation of the Limited memory variant of {@link BFGS}. It uses a history of {@link #setM(int) m} items to
 * solve {@code n} dimension problems with {@code O(m n)} work per iteration.
 *
 * @author Edward Raff
 */
public class LBFGS implements Optimizer2 {
  ...
  /**
   * Creates a new L-BFGS optimization object that uses a maximum of 500 iterations and a
   * {@link BacktrackingArmijoLineSearch Backtracking} line search. A {@link #setM(int) history} of 10 items will be
   * used
   */
  public LBFGS() {
    this(10);
