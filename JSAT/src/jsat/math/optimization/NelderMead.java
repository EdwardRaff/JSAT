...
/**
 * The Nelder-Mean algorithm is a simple directed search method. As such, it does not need any information about the
 * target functions derivative, or any data points. To perform best, the Nelder-Mean method needs N+1 reasonable initial
 * guesses for an N dimensional problem. <br>
 * The Nelder-Mean method has the advantage that the only information it needs about the function it is going to
 * minimize, is the function itself.
 *
 * @author Edward Raff
 */
public class NelderMead implements Optimizer {
   ...
   * @param initalPoints the list of initial guess points. If too small, new ones will be generated. if too large, the
   * extra ones will be ignored. This list may not be empty
