...
/**
 * An implementation of Backtraking line search using the Armijo rule. The search for alpha is done by quadratic and
 * cubic interpolation without using any derivative evaluations.
 *
 * @author Edward Raff
 */
public class BacktrackingArmijoLineSearch implements LineSearch {
   ...
   *
   * @param rho constant to decrease alpha by in (0, 1) when interpolation is not possible
   * @param c1 the <i>sufficient decrease condition</i> condition constant in (0, 1/2)
   */
