...
/**
 * Adam is inspired by {@link RMSProp} and {@link AdaGrad}, where the former can be seen as a special case of Adam. Adam
 * has been shown to work well in training neural networks, and still converges well with sparse gradients.<br>
 * NOTE: that while it will converge, Adam dose not support sparse updates. So runtime when in highly sparse
 * environments will be hampered. <br>
 * <br>
 * See: Kingma, D. P.,&amp;Ba, J. L. (2015). <i>Adam: A Method for Stochastic Optimization</i>. In ICLR.
 *
 * @author Edward Raff
 */
