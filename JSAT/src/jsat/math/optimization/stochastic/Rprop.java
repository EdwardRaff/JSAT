...
/**
 * The Rprop algorithm provides adaptive learning rates using only first order information. Rprop works best with the
 * true gradient, and may not work well when using stochastic gradients.<br>
 * <br>
 * See: Riedmiller, M., & Braun, H. (1993). <i>A direct adaptive method for faster backpropagation learning: the RPROP
 * algorithm</i>. IEEE International Conference on Neural Networks, 1(3), 586–591. doi:10.1109/ICNN.1993.298623
 *
 * @author Edward Raff
 */
