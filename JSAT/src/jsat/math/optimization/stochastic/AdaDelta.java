...
/**
 * AdaDelta is inspired by {@link AdaGrad} and was developed for use primarily in neural networks. It still maintains a
 * per feature learning rate, however unlike AdaGrad the learning rates may increase over time and are highly robust to
 * any individual learning rate. <br>
 * <br>
 * See: Zeiler, M. D. (2012). <i>ADADELTA: An Adaptive Learning Rate Method</i>. CoRR, abs/1212.5.
 *
 * @author Edward Raff
 */
public class AdaDelta implements GradientUpdater {
  ...
  /**
   * Sets the decay rate used by AdaDelta. Lower values focus more on the current gradient, where higher values
