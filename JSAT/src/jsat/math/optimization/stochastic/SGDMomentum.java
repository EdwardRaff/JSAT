...
/**
 * Performs unaltered Stochastic Gradient Decent updates using either standard or Nestrov momentum. <br>
 * <br>
 * See:<br>
 * <ul>
 * <li>Bengio, Y., Boulanger-Lewandowski, N.,&amp;Pascanu, R. (2013). <i>Advances in optimizing recurrent networks</i>.
 * In 2013 IEEE International Conference on Acoustics, Speech and Signal Processing (pp. 8624–8628). IEEE.
 * doi:10.1109/ICASSP.2013.6639349</li>
 * <li>Sutskever, I., Martens, J., Dahl, G.,&amp;Hinton, G. (2013). <i>On the importance of initialization and momentum
 * in deep learning</i>. JMLR W&amp;CP, 28, 1139–1147.</li>
 * </ul>
 *
 * @author Edward Raff
 */
public class SGDMomentum implements GradientUpdater {
   ...
   * @param nestrov {@code true} to use Nestrov momentum, {@code false} for standard.
   */
