...
/**
 * This interface provides the contract for a multivariate numerical optimization method. An optimizer may be general or
 * meant for a specific class of problems. Its goal is to find the value of the function that minimizes the prediction
 * error.
 *
 * @author Edward Raff
 */
public interface Optimizer extends Serializable {
  ...
  /**
   * Performs optimization on the given inputs to find the minima of the function. Not all optimization functions
   * require all the parameters to work, and may except some null values.
   *
   ...
   * @param vars contains the initial estimate of the minima. The length should be equal to the number of variables
   * being solved for. This value may be altered. This value can not be null.
