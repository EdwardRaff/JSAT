...
public interface RootFinder extends Serializable {
  ...
  /**
   * Attempts to numerical compute the root of a given function, such that f(<tt>args</tt>) = 0. Only one variable may
  ...
  /**
   * Different root finding methods require different numbers of initial guesses. Some root finding methods require 2
   * guesses, each with values of opposite sign so that they bracket the root. Others just need any 2 initial guesses
   * sufficiently close to the root. This method simply returns the number of guesses that are needed.
   *
