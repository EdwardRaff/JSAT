...
public abstract class ContinuedFraction {
   ...
   * @param args
   *          the values to input for the variables of the continued fraction
   ...
   * @param args
   *          the values for the variables of the continued fraction
   ...
   *
   * @param args
   *          the numeric inputs to the continued fraction
