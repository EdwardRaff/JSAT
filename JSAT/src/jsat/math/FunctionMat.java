...
public interface FunctionMat {
   ...
   *
   * @param x the variables to evaluate as part of the function
   * @param s the matrix to store the result in, or {@code null} if a new matrix should be allocated
   * @return the matrix containing the results. This is the same object as {@code s} if {@code s} is not {@code null}
   */
