...
public interface FunctionVec {
   ...
   *
   * @param x the input to compute the output from
   * @param s the vector to store the result in, or {@code null} if a new vector should be allocated
   * @return the vector containing the results. This is the same object as {@code s} if {@code s} is not {@code null}
   */
   ...
   * @return the vector containing the results. This is the same object as {@code s} of {@code s} is not {@code null}
   */
