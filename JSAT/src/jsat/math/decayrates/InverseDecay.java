 ...
 * max time being irrelevant. More specifically as &eta; / (
 * {@link #setAlpha(double) &alpha;}({@link #setTau(double) &tau;} + time))<br>
 * <br>
...
public class InverseDecay implements DecayRate, Parameterized {
  ...
  /**
   * Controls the scaling of the divisor, increasing &alpha; dampens the whole
   * range of values. Increasing it increases the values. value.
   *
   * @param alpha
