...
/**
 * The Linear Decay requires the maximum time step to be explicitly known ahead of time. Provided either in the call to 
 * {@link #rate(double, double, double) }, or internal by {@link #setMinRate(double) }. <br>
 * <br>
 * The Linear Decay will decay at a constant rate / slope from the initial value until the specified {@link #setMinRate(double)
 * } is reached.
 *
 * @author Edward Raff
 */
