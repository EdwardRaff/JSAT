...
/**
 *
 * Provides a fake {@link ExecutorService} that immediatly runs any given runnable on the main thread. This will not use
 * any given threads and will never create a thread.
 *
 * @author Edward Raff
 */
