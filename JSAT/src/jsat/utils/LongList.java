...
/**
 * Provides a modifiable implementation of a List using an array of longs. This provides considerable memory efficency
 * improvements over using an {@link ArrayList} to store longs. Null is not allowed into the list.
 *
 * @author Edward Raff
 */
