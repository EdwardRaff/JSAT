...
/**
 * A hash map for storing the primitive types of long (as keys) to doubles (as table). The implementation is based on
 * Algorithm D (Open addressing with double hashing) from Knuth's TAOCP page 528.
 *
 * @author Edward Raff
 */
