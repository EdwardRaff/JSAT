...
/**
 * Provides implementations of quicksort. This is for use to obtain explicitly desired behavior, as well as aovid
 * overhead by explicitly allowing extra Lists when sorting that are swapped when the array/list being sorted is
 * swapped. <br>
 * <br>
...
public class QuickSort {
  ...
  /**
   * Performs sorting based on the double values natural comparator. {@link Double#NaN} values will not be handled
   * appropriately.
   *
