 ...
 * {@link ArrayList} to store integers. Null is not allowed into the list.
 *
 * @author Edward Raff
 */
public class IntList extends AbstractList<Integer>implements Serializable {
  ...
  /**
   * Creates and returns a view of the given int array that requires only a
   ...
   *
   * @param array
   *          the array to wrap by an IntList object
   * @param length
   *          the initial length of the list
   * @return an IntList backed by the given array, unless modified to the point
   *         of requiring the allocation of a new array
   */
