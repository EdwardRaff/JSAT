...
/**
 *
 * This class provides Static system information that may be useful for algorithms that want to adjust their behavior
 * based on the system's hardware information. All information supposes that hardware is consistent, ie: all memory
 * installed is of the same type and all CPUs installed are the same model and stepping.
 *
 * @author Edward Raff
 */
